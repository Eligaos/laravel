...
class GameLobbyController extends Controller
{
    ...
    public function top10(){
        if (Auth::user()){
            $playersTop10 = DB::select( DB::raw("select winner as 'Player', count(*) as 'Wins' from games WHERE status = 'finished' group by winner, updated_at ORDER BY 2, updated_at asc LIMIT 10;"));
